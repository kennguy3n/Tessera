...
export const SettingsUpdateSchema = z.object({
  ...
  // Phase 19 PR 10b Task 6 — per-app keychain ACL enforcement. The
  // handler logs the transition because flipping this to `false`
  // on Linux materially weakens the at-rest protection of secrets
  // (basic_text fallback = XOR-with-hardcoded-key). macOS / Windows
  // installs are unaffected by the value.
