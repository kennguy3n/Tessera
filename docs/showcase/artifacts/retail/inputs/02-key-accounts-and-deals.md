# Key Accounts & Open Deals — Northwind Outdoor Co.
...
2. **Alpine Co-op (Central)** — Reseller. ARR $780K. Health: Yellow (late payments,
   support escalations). Renewal Jul 2026. Risk of 10% contraction. Owner: R. Mills.
3. **TrailMart (East)** — Big-box. ARR $2.1M. Health: Green. Expansion: private-label
   packs, ~$540K, stage Commit. Owner: D. Singh.
4. **Nordic Outfitters (Intl)** — Distributor. ARR $640K. Health: Green. New lane
   into Scandinavia, ~$300K, stage Pipeline. Owner: L. Tran.
5. **Urban Trek (West)** — DTC partner. ARR $410K. Health: Red (considering competitor).
...
- Margin up 150bps on apparel mix shift — protect by prioritizing apparel attach.
