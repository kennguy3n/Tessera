...
source indexing and selection, inline citations, four purpose-built editors, and exports to
the formats teams actually use — plus zero-setup onboarding for non-technical users. The local
model is the engine; the workspace is the value.
