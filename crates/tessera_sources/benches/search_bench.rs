...
const COMMON_TOKENS: &[&str] = &[
    ...
    "psi", "omega", "lorem", "ipsum", "dolor", "amet", "consectetur", "adipiscing", "elit", "sed",
    ...
    "ea", "commodo", "consequat", "duis", "aute", "irure", "reprehenderit", "voluptate", "velit",
...
fn bench_at_size(c: &mut Criterion, label: &str, chunk_count: usize) {
    ...
    let mut bm25_only_cfg = HybridSearchConfig::default();
    bm25_only_cfg.vector_weight = 0.0;
