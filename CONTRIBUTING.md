...
|---|---|---|
| **Rust** | 1.86+ (stable) | Core engine, N-API bridge |
...
- **Edition:** 2021, minimum Rust version 1.86 (transitive deps require `edition2024` (≥1.85) and `icu_collections >=2.2.0` requires 1.86).
